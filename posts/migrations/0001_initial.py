# Generated by Django 2.2.5 on 2020-03-15 23:14
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='sub_categories', to='posts.Category')),
            ],
            options={
                'ordering': ('name',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thumbnail', imagekit.models.fields.ProcessedImageField(upload_to='posts')),
